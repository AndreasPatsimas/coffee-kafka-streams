...
public class KafkaAvroProducer {
    ...
    public static void main(String args[]){
        ...
        deviceProducer.send(deviceProducerRecord, (recordMetadata, e) -> {
            System.out.println(recordMetadata.toString());
            System.out.println(e);
        });

        coffeeProducer.send(coffeeProducerRecord, (recordMetadata, e) -> {
            System.out.println(recordMetadata.toString());
            System.out.println(e);
        });

        coffeeMachineProducer.send(coffeeMachineProducerRecord, (recordMetadata, e) -> {
            System.out.println(recordMetadata.toString());
            System.out.println(e);
        });

        customerProducer.send(customerProducerRecord, (recordMetadata, e) -> {
